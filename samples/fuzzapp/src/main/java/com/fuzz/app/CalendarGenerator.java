...
public class CalendarGenerator extends Generator<GregorianCalendar> {
    ...
    @Override
    public GregorianCalendar generate(final SourceOfRandomness random, final GenerationStatus __ignore__) {
        ...
        final String[] allTzIds = TimeZone.getAvailableIDs();

        // Next, choose one randomly from the array
        final String tzId = random.choose(allTzIds);
